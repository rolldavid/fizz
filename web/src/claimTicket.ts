/**
 * ⚠️ VERBATIM COPY of src/lib/aztec/claimTicket.ts (the extension's module).
 * The two files MUST stay in sync below this banner — the extension decodes
 * exactly what this page encodes. If you change one, change the other (web/
 * is a standalone package and intentionally does not import across the repo).
 *
